...
<template>
    <section class="footer-bottom">
        <article class="footer-bottom__info">
        ...
        <article class="footer-bottom__tools">
            <svg class="footer-bottom__tools-icon" height="25px" width="25px" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 128 128">
                <path fill="none"
            ...
            <svg class="footer-bottom__tools-icon" height="25px" width="25px" xmlns="http://www.w3.org/2000/svg"
                ...
                <path fill="url(#IconifyId19e6e440a5e269687264)"
                ...
                <path fill="url(#IconifyId19e6e440a5e269687265)"
                ...
                <path fill="url(#IconifyId19e6e440a5e269687266)"
                ...
                <defs>
                    <linearGradient id="IconifyId19e6e440a5e269687264" x1="34.513" x2="27.157" y1="15.535" y2="30.448"
                    ...
                    <linearGradient id="IconifyId19e6e440a5e269687265" x1="30.009" x2="50.533" y1="23.359" y2="8.288"
                        gradientTransform="translate(0 24.664)scale(1.51263)" gradientUnits="userSpaceOnUse">
                    ...
                    <linearGradient id="IconifyId19e6e440a5e269687266" x1="21.917" x2="40.555" y1="22.261" y2="22.261"
                        gradientTransform="translate(0 24.664)scale(1.51263)" gradientUnits="userSpaceOnUse">
